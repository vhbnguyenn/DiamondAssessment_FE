...
const AdminSystemSettings: React.FC = () => {
  ...
  const generateApiKey = () => {
    const newApiKey = `dk_live_${Math.random()
      .toString(36)
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="general" className="space-y-6">
          <Card className="bg-white/80 backdrop-blur-md border-0 shadow-lg">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField label="Company Name">
                    <Input
                      ...
                      onChange={(e) =>
                        updateSettings("general", "companyName", e.target.value)
                      }
              ...
              <SettingsSection
                title="Branding"
                description="Logo and visual identity settings"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    label="Logo URL"
          ...
          <Card className="bg-white/80 backdrop-blur-md border-0 shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              <SettingsSection
                ...
                description="Configure sender information"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <FormField label="Reply To Email">
                    <Input
                      ...
                      onChange={(e) =>
                        updateSettings("email", "replyToEmail", e.target.value)
                      }
                      className="bg-white/70 border-slate-200 focus:border-blue-500"
                    />
                  </FormField>
                ...
                <FormField label="Email Signature">
                  <Textarea
                    ...
                    onChange={(e) =>
                      updateSettings("email", "emailSignature", e.target.value)
                    }
                    className="bg-white/70 border-slate-200 focus:border-blue-500"
                    rows={4}
                  />
        ...
        <TabsContent value="payment" className="space-y-6">
          <Card className="bg-white/80 backdrop-blur-md border-0 shadow-lg">
            ...
            <CardContent className="space-y-6">
              <SettingsSection
                title="VNPay Integration"
                description="Configure VNPay payment gateway"
              >
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <Label>Enable VNPay Payments</Label>
                    <p className="text-xs text-slate-500">
                      Allow customers to pay via VNPay
                    </p>
                  </div>
                  <Switch
                    checked={settings.payment.vnpayEnabled}
                    onCheckedChange={(checked) =>
                      updateSettings("payment", "vnpayEnabled", checked)
                    }
                  />
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      <Input
                        ...
                        onChange={(e) =>
                          updateSettings("payment", "vnpayUrl", e.target.value)
                        }
                        className="bg-white/70 border-slate-200 focus:border-blue-500"
                      />
                    </FormField>
              ...
              <SettingsSection
                title="Bank Transfer"
                description="Configure bank transfer payments"
              >
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <Label>Enable Bank Transfer</Label>
                    <p className="text-xs text-slate-500">
                      Allow manual bank transfer payments
                    </p>
                  </div>
                  <Switch
                    checked={settings.payment.bankTransferEnabled}
                    onCheckedChange={(checked) =>
                      updateSettings("payment", "bankTransferEnabled", checked)
                    }
                  />
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField label="Bank Name">
                      <Input
                        ...
                        onChange={(e) =>
                          updateSettings("payment", "bankName", e.target.value)
                        }
                        className="bg-white/70 border-slate-200 focus:border-blue-500"
                      />
                    </FormField>
              ...
              <SettingsSection
                ...
                description="Tax rates and currency settings"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    label="Tax Rate (%)"
                  ...
                  <FormField label="Default Currency">
                    <select
                      ...
                      onChange={(e) =>
                        updateSettings("payment", "currency", e.target.value)
                      }
                      className="bg-white/70 border border-slate-200 focus:border-blue-500 rounded p-2 w-full"
                    >
                      <option value="VND">Vietnamese Dong (VND)</option>
        ...
        <TabsContent value="assessment" className="space-y-6">
          <Card className="bg-white/80 backdrop-blur-md border-0 shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Configure diamond assessment workflow and policies
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <SettingsSection
                title="Processing Limits"
                description="Control assessment workload and capacity"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    label="Max Assessments Per Day"
                    description="Maximum number of assessments to accept daily"
                  >
                    <Input
                      type="number"
                      min="1"
                  ...
                  <FormField
                    label="Standard Processing Time (hours)"
                    description="Normal turnaround time"
                  >
                    <Input
                      type="number"
                      min="1"
                  ...
                  <FormField
                    label="Rush Processing Time (hours)"
                    description="Express service turnaround time"
                  >
                    <Input
                      type="number"
                      min="1"
              ...
              <SettingsSection
                ...
                description="Configure quality assurance policies"
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        Require secondary review for all assessments
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        Automatically assign assessments to available staff
                      </p>
                    </div>
                    <Switch
              ...
              <SettingsSection
                ...
                description="Configure data and sample retention"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    label="Certificate Validity (days)"
                    description="How long certificates remain valid"
                  >
                    <Input
                      type="number"
                      min="30"
                  ...
                  <FormField
                    ...
                    description="How long to keep physical samples"
                  >
                    <Input
                      type="number"
                      min="7"
          ...
          <Card className="bg-white/80 backdrop-blur-md border-0 shadow-lg">
            ...
            <CardContent className="space-y-6">
              <SettingsSection
                ...
                description="Enable or disable notification methods"
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        Notify when assessment is finished
                      </p>
                    </div>
                    <Switch
        ...
        <TabsContent value="api" className="space-y-6">
          <Card className="bg-white/80 backdrop-blur-md border-0 shadow-lg">
            ...
            <CardContent className="space-y-6">
              <SettingsSection
                title="API Access"
                description="Control API availability and authentication"
              >
                <div className="flex items-center justify-between mb-4">
                  <div>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateSettings("api", "apiEnabled", checked)
                    }
                  />
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <Input
                        ...
                        onChange={(e) =>
                          updateSettings("api", "webhookUrl", e.target.value)
                        }
                        className="bg-white/70 border-slate-200 focus:border-blue-500"
          ...
          <Card className="bg-white/80 backdrop-blur-md border-0 shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateSettings("maintenance", "maintenanceMode", checked)
                    }
                  />
                </div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateSettings("maintenance", "backupEnabled", checked)
                    }
                  />
                </div>
              ...
              <SettingsSection
                ...
                description="Configure logging and debugging"
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateSettings("maintenance", "debugMode", checked)
                      }
                    />
                  </div>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent className="bg-white/95 backdrop-blur-md">
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will permanently delete all system logs. This
